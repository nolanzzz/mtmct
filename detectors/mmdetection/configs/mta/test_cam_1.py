...
data = dict(
    ...
    test=dict(
        type=dataset_type,
        ann_file=data_root + 'test_cam_1/coords.json',
        img_prefix=data_root + 'test_cam_1/images/',
        pipeline=test_pipeline))
...
log_level = 'INFO'
work_dir = './work_dirs/GtaDataset_30e'
load_from = None
resume_from = None
# resume_from = './work_dirs/GtaDataset_30e/latest.pth'
workflow = [('train', 1)]
