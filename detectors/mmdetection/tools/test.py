...
def parse_args():
    ...
    parser.add_argument('--pkl_input', help='input result file in pickle format')
    parser.add_argument(
        '--format_only',
        action='store_true',
...
def main():
    ...
    # If an input pickle file has been specified use this
    if not args.pkl_input:
        if not distributed:
        ...
        outputs = mmcv.load(args.pkl_input)
