...
CUDA_VISIBLE_DEVICES="0" python track.py mot --test_mta True --exp_id "$1" --load_model '../exp/mot/high_30_complete/model_last.pth' --data_dir '../data/MTA_short/' --conf_thres 0.4 --gpus 0
cd ../../..
