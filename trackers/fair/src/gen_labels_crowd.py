...
if __name__ == '__main__':
    data_val = '/data/MOT/JDE/crowdhuman/images/val'
    label_val = '/data/MOT/JDE/crowdhuman/labels_with_ids/val'
    ann_val = '/data/MOT/JDE/crowdhuman/annotation_val.odgt'
    data_train = '/data/MOT/JDE/crowdhuman/images/train'
    label_train = '/data/MOT/JDE/crowdhuman/labels_with_ids/train'
    ann_train = '/data/MOT/JDE/crowdhuman/annotation_train.odgt'
