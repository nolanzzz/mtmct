...
class JDETracker(object):
    def __init__(self, opt, frame_rate=30, use_cuda=True):
        self.opt = opt
        if opt.gpus[0] >= 0:
    ...
    def update_store_detections(self, im_blob, img0, cam_id, frame_id):
        ...
        feature_pickle_folder = "/u40/zhanr110/mtmct/work_dirs/tracker/config_runs/fair_features_long_short_test/features"
        track_feature_pickle_folder = "/u40/zhanr110/mtmct/work_dirs/clustering/config_runs/fair_features_long_short_test/pickled_appearance_features"
