...
from util_iou import load_mot, iou
...
def track_iou(detections, sigma_l, sigma_h, sigma_iou, t_min):
    ...
    for frame_num, detections_frame in tqdm(enumerate(detections, start=1)):
        ...
        # create new tracks
        new_tracks = [{'bboxes': [det['bbox']], 'max_score': det['score'], 'start_frame': det["frame_no_cam"]} for det in dets]
