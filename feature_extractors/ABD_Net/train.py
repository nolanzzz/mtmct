...
sys.argv[1:] = ['-s', 'market1501', '-t', 'market1501', '--height', '256', '--width', '128', '--test-batch-size', '100', '--evaluate', '-a', 'resnet50', '--load-weights', '/media/philipp/philippkoehl_ssd/work_dirs/feature_extractor/abd-net/market_checkpoint_best.pth.tar', '--save-dir', '/media/philipp/philippkoehl_ssd/work_dirs/feature_extractor/abd-net/log/eval-resnet50', '--gpu-devices', '0', '--root', '/media/philipp/philippkoehl_ssd/work_dirs/datasets', '--use-cpu']
    ...
    with torch.no_grad():
        ...
        for batch_idx, package in enumerator:
            ...
            if flip_eval:
                ...
                #print("imgs tensor size: {}".format(imgs.size()))
