...
# wda_tracker
python run_tracker.py --config configs/tracker_configs/new_test_20e_cam_1_new_short_full.py
...
CUDA_VISIBLE_DEVICES="1,2,3" python tools/train.py configs/mta/mta_high.py --gpus 3
