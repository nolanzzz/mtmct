...
CUDA_VISIBLE_DEVICES="2,3" python train.py mot --exp_id hrnetv2_w18_imagenet_pretrained.pth --num_epochs 20 --load_model '../models/hrnetv2_w18_imagenet_pretrained.pth' --data_cfg '../src/lib/cfg/mta.json' --gpus 2,3
