# Fair
CUDA_VISIBLE_DEVICES="0, 3" python track.py mot --exp_id fair_short_features_train --test_mta True --load_model '../exp/mot/mta_long_dla34/model_last.pth' --data_dir '../data/MTA_short/' --conf_thres 0.4 --gpus 0,3
