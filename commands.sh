...
python train.py mot --exp_id dla34_imagenet --num_epochs 15 --load_model '../models/dla34-imagenet.pth' --data_cfg '../src/lib/cfg/mta.json'
...
CUDA_VISIBLE_DEVICES="1, 2" python visualize.py mot --exp_id new_test --test_mta True --data_dir '../data/MTA_short/'

# wda_tracker
CUDA_VISIBLE_DEVICES="1,2" python run_tracker.py --config configs/tracker_configs/frcnn50_new_abd_test.py
