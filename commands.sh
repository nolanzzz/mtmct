...
python track.py mot --train_mta True --exp_id dla34_coco_wda_short_train --load_model '../exp/mot/dla34_coco_wda_short/model_last.pth' --data_dir '../data/MTA_short/' --conf_thres 0.4
python evaluate.py mot --test_mta True --exp_id dla34_coco_wda_short_test --data_dir '../data/MTA_short/'
...
python tools/test.py configs/mta/test_cam_1.py work_dirs/GtaDataset_30e/epoch_20.pth --eval bbox
python tools/test.py configs/mta/test_cam_1.py /u40/zhanr110/mtmct/work_dirs/detector/faster_rcnn_gta22.07_epoch_5.pth --eval bbox
