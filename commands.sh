...
CUDA_VISIBLE_DEVICES="1,2,3" python train.py mot --exp_id mta_full_5_epochs --num_epochs 5 --load_model '../exp/mot/mot17_dla34/model_last.pth' --data_cfg '../src/lib/cfg/mta.json' --gpus 1,2,3
...
# wda_tracker
CUDA_VISIBLE_DEVICES="0, 3" python run_tracker.py --config configs/tracker_configs/frcnn50_new_abd_train.py
