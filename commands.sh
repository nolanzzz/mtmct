...
python track.py mot --test_mta True --exp_id dla34_coco_wda_short_new_cam_1 --load_model '../exp/mot/dla34_coco_wda_short/model_last.pth' --data_dir '../data/MTA_short/' --conf_thres 0.4
