# Fair
CUDA_VISIBLE_DEVICES="0, 3" python track.py mot --exp_id fair_features_4_10000_35e --test_mta True --load_model '../exp/mot/mta_4_10000/model_last.pth' --data_dir '../data/MTA_short/' --conf_thres 0.4 --gpus 0,3
