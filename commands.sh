# Fair
CUDA_VISIBLE_DEVICES="2, 3" python track.py mot --exp_id fair_detections_features_long_box50 --test_mta True --load_model '../exp/mot/mta_long_dla34/model_last.pth' --data_dir '../data/MTA_short/' --conf_thres 0.4 --gpus 2,3
