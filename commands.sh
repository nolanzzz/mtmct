...
CUDA_VISIBLE_DEVICES="1, 2" python visualize.py mot --exp_id wda_5epoch_mmdet_resnet50_train --test_mta True --data_dir '../data/MTA_short/'

# wda_tracker
CUDA_VISIBLE_DEVICES="1,2,3" python run_tracker.py --config configs/tracker_configs/frcnn50_new_abd_train.py
