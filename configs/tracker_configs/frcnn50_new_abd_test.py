root = {
    ...
    "detector" : {
        ...
        "mmdetection_checkpoint_file" : "detectors/mmdetection/work_dirs/faster_rcnn_r50_mta_5epoch/latest.pth",
        "device" : "cuda:1,2,3",
    ...
    "feature_extractor" : {
        ...
        "feature_extractor_name" : "abd_net_extractor"
            ...
            ,"abd_net_extractor" : dict(abd_dan=['cam', 'pam'], abd_dan_no_head=False, abd_dim=1024, abd_np=2, adam_beta1=0.9,
                  ...
                  global_max_pooling=False, gpu_devices='1,2,3', height=384, htri_only=False, label_smooth=True,
